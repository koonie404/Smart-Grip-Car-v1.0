...
STM32 기반 UART 통신 및 센서 제어를 활용한 Smart RC Car 프로젝트입니다.

> 이 저장소는 Smart Grip Car의 v1.0 원형 프로젝트입니다. STM32 기반 모터·센서·그리퍼 제어 구조를 구현했으며, 이후 [Smart Grip Car v1.1](https://github.com/koonie404/Smart-Grip-Car-Ver1.1)에서 Raspberry Pi, 웹 UI, YOLOv8 객체 인식 기능으로 확장했습니다.
...
Smart Grip Car v1.0은 STM32F103 기반의 스마트 RC Car 프로젝트입니다.
...
아래 확장 방향은 별도 v1.1 프로젝트에서 일부 구현했습니다.

- Raspberry Pi 기반 웹 제어 시스템 확장
- 카메라 기반 영상 처리 기능 추가
- YOLOv8 객체 인식 기능 연동
- 자율주행 알고리즘 적용
- 장애물 회피 기능 고도화

확장 버전: [Smart Grip Car v1.1](https://github.com/koonie404/Smart-Grip-Car-Ver1.1)
